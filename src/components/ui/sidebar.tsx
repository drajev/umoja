...
type SidebarRailProps = ComponentPropsWithRef<'button'>;
...
type SidebarInsetProps = ComponentPropsWithRef<'main'>;
...
type SidebarGroupActionProps = ComponentPropsWithRef<'button'> & {
  asChild?: boolean;
};
...
type SidebarMenuActionProps = ComponentPropsWithRef<'button'> & {
  asChild?: boolean;
  showOnHover?: boolean;
};
...
type SidebarMenuSkeletonProps = ComponentPropsWithRef<'div'> & {
  showIcon?: boolean;
};
