...
type ToastRootProps = ComponentPropsWithRef<typeof ToastPrimitives.Root> &
  VariantProps<typeof toastVariants>;

const Toast = ({ className, variant, ref, ...props }: ToastRootProps) => {
  return (
...
type ToastActionProps = ComponentPropsWithRef<typeof ToastPrimitives.Action>;
...
type ToastCloseProps = ComponentPropsWithRef<typeof ToastPrimitives.Close>;
...
type ToastTitleProps = ComponentPropsWithRef<typeof ToastPrimitives.Title>;
